...
local function PodeAgir()
    if not hasGKTool() then return false end
...
function InitWindUI()
    ...
    MobileTab:Paragraph({
        ...
        Desc=isMobile and 'Use o teclado virtual abaixo. Ele envia E, C, Q, Z, R, F e Space para o Auto Dive.' or 'Abra no celular para usar o teclado virtual.',
    })
    MobileTab:Toggle({
